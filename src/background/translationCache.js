...
console.log("translationCache.js is running")

import { deleteAiTranslationCache } from "./aiTranslationCache.js";
...
const translationCache = (function () {
  ...
  chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.action === "getCacheSize") {
      ...
      // Also delete AI translation cache databases
      deleteAiTranslationCache().catch(e => console.error("[AI-CACHE] delete via cache manager failed:", e));
    }
  });
