...
/**
 * 在用户点击"翻译选中文本"按钮后,
 * 对于firefox等有browserAction.setPopup接口的浏览器,可以在sw.js直接调用browserAction.setPopup()弹出本HTML
 * 对于chrome等没有browserAction.setPopup接口的浏览器,需要从sw.js向contentScript发送消息,content script里再调用translateSelected.js里的相关函数弹出翻译窗口
 */
