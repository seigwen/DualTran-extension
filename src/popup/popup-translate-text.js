...
/**
 * After the user clicks the "Translate selected text" button,
 * For browsers like Firefox with browserAction.setPopup, sw.js can directly call browserAction.setPopup() to open this HTML
 * For browsers like Chrome without browserAction.setPopup, sw.js sends a message to the content script, which then calls functions in translateSelected.js to open the translation popup
 */
