...
console.log("languages.js is running")
...
const twpLang = (function () {
  ...
  const pageTranslationServices = ["google", "yandex", "microsoft"];
  /**
  ...
  twpLang.codeToLanguageNameInEnglish = function (langCode) {    
    const languageList = allLanguagesNames['en'];
    const languageName = languageList[langCode]
    return languageName
  };
