...
console.log("i18n.js is running")
...
void (function () {
   ...
   */
  //@ts-ignore
  chrome.i18n.translateDocument = function (root) {
    if(root === undefined){
      if('undefined' !== (typeof document)){
        root = document
      } else {
        console.log("chrome.i18n.translateDocument() can not run because it is running in a context withou document object!!!")
        return
      }
    }
